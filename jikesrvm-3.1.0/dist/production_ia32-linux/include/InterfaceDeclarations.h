...
struct BootRecord {
  ...
  uint32_t    headerPadding1;
   ...
   Address sysPerfCtrInitIP;
   Address sysPerfCtrReadIP;
   Address sysPerfCtrReadCyclesIP;
   Address sysPerfCtrReadMetricIP;
};
#endif /* NEED_BOOT_RECORD_DECLARATIONS */

#ifdef NEED_BOOT_RECORD_INITIALIZATION
extern "C" int sysPerfCtrReadMetric();
extern "C" int sysPerfCtrReadCycles();
extern "C" int sysPerfCtrRead();
extern "C" int sysPerfCtrInit();
...
extern "C" void setLinkage(BootRecord* br){
  br->sysPerfCtrReadMetricIP = (intptr_t)sysPerfCtrReadMetric;
  br->sysPerfCtrReadCyclesIP = (intptr_t)sysPerfCtrReadCycles;
  br->sysPerfCtrReadIP = (intptr_t)sysPerfCtrRead;
  br->sysPerfCtrInitIP = (intptr_t)sysPerfCtrInit;
...
static const void *bootImageDataAddress                     = (void*)0x10000000;
static const void *bootImageCodeAddress                     = (void *)0x14000000;
static const void *bootImageRMapAddress                     = (void *)0x16000000;
...
const Offset RVMThread_stack_offset = 0x00000098;
const Offset RVMThread_stackLimit_offset = 0x0000009c;
const Offset RVMThread_exceptionRegisters_offset = 0x000000dc;
const Offset RVMThread_jniEnv_offset = 0x00000118;
const Offset RVMThread_execStatus_offset = 0x0000005c;
...
const Offset JNIEnvironment_JNIExternalFunctions_offset = 0xfffffffc;
...
const Offset Thread_framePointer_offset = 0x000000a0;
const Offset Thread_arrayIndexTrapParam_offset = 0x000000a8;
