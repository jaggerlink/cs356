...
public final class ThinLock implements ThinLockConstants {
  ...
  // RaceDet: handle lock acquire and split into two parts (inlineLock and inlineLockHelper)
  ...
  public static void inlineLock(Object o, Offset lockOffset) {
    inlineLockNoInline(o, lockOffset);
  }
  ...
  // RaceDet: handle lock release and split into two parts (inlineUnlock and inlineUnlockHelper)
  ...
  public static void inlineUnlock(Object o, Offset lockOffset) {
    inlineUnlockNoInline(o, lockOffset);
  }  
  ...
  public static final int getRecursionCountLocked(Object o, Offset lockOffset) {
    if (VM.VerifyAssertions) { VM._assert(holdsLock(o, lockOffset, RVMThread.getCurrentThread())); }
    Word bits = Magic.getWordAtOffset(o, lockOffset);
    int count;
    if (bits.and(TL_STAT_MASK).EQ(TL_STAT_FAT)) {
      ...
      if (VM.VerifyAssertions) { VM._assert(bits.and(TL_STAT_MASK).EQ(TL_STAT_BIASABLE) || bits.and(TL_STAT_MASK).EQ(TL_STAT_THIN)); }
