...
public class ScanBootImage implements Constants {
   ...
   */
  // RaceDet: make sure we don't encode a run for the very first offset, which might be zero
  // RaceDet: LATER: this could be considered a Jikes bug :)
  private static int lastOffset = Integer.MIN_VALUE / 2; //0;
